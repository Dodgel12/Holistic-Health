...
<aside class="sidebar">
    ...
    <div class="sidebar-footer">
        <button id="themeToggle" class="nav-item" style="width:100%; border:none; background:none; cursor:pointer; text-align:left;">
            <svg class="sun-icon" style="display:none;" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <svg class="moon-icon" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
